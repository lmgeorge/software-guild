...
public class CalculatorTest {
  ...
  public void testCalcTotalTax() {
    ...
    calc.setLaborCost(3);
    assertEquals(8*(1.5/100), calc.calcTotalTax(1.5/100), 0);
    
    calc.setMaterialCost(9);
    calc.setLaborCost(60);
    assertEquals((60+9)*(3.25/100), calc.calcTotalTax(3.25/100), 0);
  }
  ...
  public void testCalcTotalCost() {
    calc.setMaterialCost(9);
    calc.setLaborCost(60);
    calc.setTotalTax(2.13/100*(60+9));
    ...
    calc.setTotalTax(4.5/100*(50.75+100.60));
